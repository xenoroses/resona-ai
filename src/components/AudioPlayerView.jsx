  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="antigravity-card rounded-2xl p-6 space-y-5">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-4 border-b border-[#2B3042]">
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 rounded-xl bg-[#6366F1]/15 border border-[#6366F1]/40 flex items-center justify-center text-[#6366F1] shrink-0">
              <Radio className="w-6 h-6 animate-pulse" />
            </div>
            <div>
              <span className="text-[11px] font-mono text-[#6366F1] uppercase font-bold">Resona Episode Player</span>
              <h3 className="text-lg font-bold text-[#F8FAFC]">{currentPodcast.title}</h3>
          ...
          <a
            ...
            className="px-4 py-2 rounded-xl bg-[#0F1117] hover:bg-[#222634] border border-[#2B3042] text-xs font-mono text-[#6366F1] flex items-center space-x-2 transition-colors shrink-0"
          >
        ...
        <div className="space-y-2">
          <input
            ...
            value={currentTime}
            onChange={handleSeek}
            className="w-full accent-[#6366F1] h-2 bg-[#0F1117] rounded-lg cursor-pointer"
          />
        ...
        <div className="flex items-center justify-between pt-2">
          <div className="flex items-center space-x-3">
            <button
              onClick={togglePlay}
              className="w-12 h-12 rounded-full bg-[#6366F1] hover:bg-[#4F46E5] text-white flex items-center justify-center shadow-lg shadow-[#6366F1]/20 transition-transform active:scale-95"
            >
      ...
      {/* Transcript Feed */}
      <div className="antigravity-card rounded-2xl p-5 space-y-4">
        <h4 className="text-xs font-bold uppercase tracking-wider text-[#94A3B8] font-mono flex items-center gap-2">
          <Sparkles className="w-3.5 h-3.5 text-[#6366F1]" /> Interactive Transcript Timeline
        </h4>
          ...
          {currentPodcast.dialogue.map((turn, idx) => {
            ...
            return (
              <div
                ...
                className="p-3.5 rounded-xl bg-[#0F1117] hover:bg-[#222634] border border-[#2B3042] cursor-pointer transition-all flex items-start justify-between gap-4 group"
              >
                ...
                <div className="w-7 h-7 rounded-full bg-[#1A1D27] group-hover:bg-[#6366F1] text-[#94A3B8] group-hover:text-white flex items-center justify-center shrink-0 transition-colors">
